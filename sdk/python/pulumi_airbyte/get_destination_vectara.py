...
__all__ = [
    'GetDestinationVectaraResult',
    'AwaitableGetDestinationVectaraResult',
    'get_destination_vectara',
    'get_destination_vectara_output',
]

@pulumi.output_type
class GetDestinationVectaraResult:
    """
...
class AwaitableGetDestinationVectaraResult(GetDestinationVectaraResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationVectaraResult(
...
def get_destination_vectara(destination_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDestinationVectaraResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationVectara:getDestinationVectara', __args__, opts=opts, typ=GetDestinationVectaraResult).value

    return AwaitableGetDestinationVectaraResult(
...
@_utilities.lift_output_func(get_destination_vectara)
def get_destination_vectara_output(destination_id: Optional[pulumi.Input[str]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDestinationVectaraResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
