...
__all__ = ['DestinationDuckdbArgs', 'DestinationDuckdb']

@pulumi.input_type
class DestinationDuckdbArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['DestinationDuckdbConfigurationArgs'],
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['DestinationDuckdbConfigurationArgs']:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: pulumi.Input['DestinationDuckdbConfigurationArgs']):
...
@pulumi.input_type
class _DestinationDuckdbState:
    def __init__(__self__, *,
                 configuration: Optional[pulumi.Input['DestinationDuckdbConfigurationArgs']] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['DestinationDuckdbConfigurationArgs']]:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input['DestinationDuckdbConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
class DestinationDuckdb(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['DestinationDuckdbConfigurationArgs']]] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DestinationDuckdb resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a DestinationDuckdb resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DestinationDuckdbArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DestinationDuckdbArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DestinationDuckdbArgs.__new__(DestinationDuckdbArgs)
        ...
        super(DestinationDuckdb, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            destination_type: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            workspace_id: Optional[pulumi.Input[str]] = None) -> 'DestinationDuckdb':
        """
        ...
        __props__ = _DestinationDuckdbState.__new__(_DestinationDuckdbState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["workspace_id"] = workspace_id
        return DestinationDuckdb(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.DestinationDuckdbConfiguration']:
        return pulumi.get(self, "configuration")
