...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] destination_id: Requires replacement if changed.
        :param pulumi.Input[str] source_id: Requires replacement if changed.
        :param pulumi.Input['ConnectionConfigurationsArgs'] configurations: A list of configured stream options for a connection.
        :param pulumi.Input[str] data_residency: must be one of ["auto", "us", "eu"]; Default: "auto"
        :param pulumi.Input[str] name: Optional name of the connection
        :param pulumi.Input[str] namespace_definition: Define the location where the data will be stored in the destination. must be one of ["source", "destination",
        ...
        :param pulumi.Input[str] non_breaking_schema_updates_behavior: Set how Airbyte handles syncs when it detects a non-breaking schema change in the source. must be one of ["ignore",
