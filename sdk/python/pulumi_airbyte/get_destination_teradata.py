...
__all__ = [
    'GetDestinationTeradataResult',
    'AwaitableGetDestinationTeradataResult',
    'get_destination_teradata',
    'get_destination_teradata_output',
]

@pulumi.output_type
class GetDestinationTeradataResult:
    """
...
class AwaitableGetDestinationTeradataResult(GetDestinationTeradataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationTeradataResult(
...
def get_destination_teradata(destination_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDestinationTeradataResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationTeradata:getDestinationTeradata', __args__, opts=opts, typ=GetDestinationTeradataResult).value

    return AwaitableGetDestinationTeradataResult(
...
@_utilities.lift_output_func(get_destination_teradata)
def get_destination_teradata_output(destination_id: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDestinationTeradataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
