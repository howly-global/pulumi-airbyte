...
__all__ = ['DestinationTeradataArgs', 'DestinationTeradata']

@pulumi.input_type
class DestinationTeradataArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['DestinationTeradataConfigurationArgs'],
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['DestinationTeradataConfigurationArgs']:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: pulumi.Input['DestinationTeradataConfigurationArgs']):
...
@pulumi.input_type
class _DestinationTeradataState:
    def __init__(__self__, *,
                 configuration: Optional[pulumi.Input['DestinationTeradataConfigurationArgs']] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['DestinationTeradataConfigurationArgs']]:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input['DestinationTeradataConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
class DestinationTeradata(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['DestinationTeradataConfigurationArgs']]] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DestinationTeradata resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a DestinationTeradata resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DestinationTeradataArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DestinationTeradataArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DestinationTeradataArgs.__new__(DestinationTeradataArgs)
        ...
        super(DestinationTeradata, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            destination_type: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            workspace_id: Optional[pulumi.Input[str]] = None) -> 'DestinationTeradata':
        """
        ...
        __props__ = _DestinationTeradataState.__new__(_DestinationTeradataState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["workspace_id"] = workspace_id
        return DestinationTeradata(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.DestinationTeradataConfiguration']:
        return pulumi.get(self, "configuration")
