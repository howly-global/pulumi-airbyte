...
__all__ = [
    'GetDestinationDuckdbResult',
    'AwaitableGetDestinationDuckdbResult',
    'get_destination_duckdb',
    'get_destination_duckdb_output',
]

@pulumi.output_type
class GetDestinationDuckdbResult:
    """
...
class AwaitableGetDestinationDuckdbResult(GetDestinationDuckdbResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationDuckdbResult(
...
def get_destination_duckdb(destination_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDestinationDuckdbResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationDuckdb:getDestinationDuckdb', __args__, opts=opts, typ=GetDestinationDuckdbResult).value

    return AwaitableGetDestinationDuckdbResult(
...
@_utilities.lift_output_func(get_destination_duckdb)
def get_destination_duckdb_output(destination_id: Optional[pulumi.Input[str]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDestinationDuckdbResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
