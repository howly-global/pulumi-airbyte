...
__all__ = ['DestinationWeaviateArgs', 'DestinationWeaviate']

@pulumi.input_type
class DestinationWeaviateArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['DestinationWeaviateConfigurationArgs'],
        ...
        :param pulumi.Input['DestinationWeaviateConfigurationArgs'] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['DestinationWeaviateConfigurationArgs']:
        """
    ...
    def configuration(self, value: pulumi.Input['DestinationWeaviateConfigurationArgs']):
...
@pulumi.input_type
class _DestinationWeaviateState:
    def __init__(__self__, *,
                 configuration: Optional[pulumi.Input['DestinationWeaviateConfigurationArgs']] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['DestinationWeaviateConfigurationArgs']]:
        """
        The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
        configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
        model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
    ...
    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input['DestinationWeaviateConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
class DestinationWeaviate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['DestinationWeaviateConfigurationArgs']]] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DestinationWeaviate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['DestinationWeaviateConfigurationArgs']] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
               configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
               model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
               Advanced configuration Processing, embedding and advanced configuration are provided by this base class, while the
               indexing configuration is provided by the destination connector in the sub class.
    ...
    def __init__(__self__,
        ...
        Create a DestinationWeaviate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DestinationWeaviateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DestinationWeaviateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DestinationWeaviateArgs.__new__(DestinationWeaviateArgs)
        ...
        super(DestinationWeaviate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            destination_type: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            workspace_id: Optional[pulumi.Input[str]] = None) -> 'DestinationWeaviate':
        """
        ...
        __props__ = _DestinationWeaviateState.__new__(_DestinationWeaviateState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["workspace_id"] = workspace_id
        return DestinationWeaviate(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.DestinationWeaviateConfiguration']:
        """
        The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
        configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
        model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
