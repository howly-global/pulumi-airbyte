...
__all__ = ['DestinationYellowbrickArgs', 'DestinationYellowbrick']

@pulumi.input_type
class DestinationYellowbrickArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['DestinationYellowbrickConfigurationArgs'],
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['DestinationYellowbrickConfigurationArgs']:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: pulumi.Input['DestinationYellowbrickConfigurationArgs']):
...
@pulumi.input_type
class _DestinationYellowbrickState:
    def __init__(__self__, *,
                 configuration: Optional[pulumi.Input['DestinationYellowbrickConfigurationArgs']] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['DestinationYellowbrickConfigurationArgs']]:
        return pulumi.get(self, "configuration")

    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input['DestinationYellowbrickConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
class DestinationYellowbrick(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['DestinationYellowbrickConfigurationArgs']]] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DestinationYellowbrick resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a DestinationYellowbrick resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DestinationYellowbrickArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DestinationYellowbrickArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DestinationYellowbrickArgs.__new__(DestinationYellowbrickArgs)
        ...
        super(DestinationYellowbrick, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            destination_type: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            workspace_id: Optional[pulumi.Input[str]] = None) -> 'DestinationYellowbrick':
        """
        ...
        __props__ = _DestinationYellowbrickState.__new__(_DestinationYellowbrickState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["workspace_id"] = workspace_id
        return DestinationYellowbrick(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.DestinationYellowbrickConfiguration']:
        return pulumi.get(self, "configuration")
