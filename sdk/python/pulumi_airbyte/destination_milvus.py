...
__all__ = ['DestinationMilvusArgs', 'DestinationMilvus']

@pulumi.input_type
class DestinationMilvusArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input['DestinationMilvusConfigurationArgs'],
        ...
        :param pulumi.Input['DestinationMilvusConfigurationArgs'] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Input['DestinationMilvusConfigurationArgs']:
        """
    ...
    def configuration(self, value: pulumi.Input['DestinationMilvusConfigurationArgs']):
...
@pulumi.input_type
class _DestinationMilvusState:
    def __init__(__self__, *,
                 configuration: Optional[pulumi.Input['DestinationMilvusConfigurationArgs']] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['DestinationMilvusConfigurationArgs']]:
        """
        The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
        configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
        model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
    ...
    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input['DestinationMilvusConfigurationArgs']]):
        pulumi.set(self, "configuration", value)
...
class DestinationMilvus(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['DestinationMilvusConfigurationArgs']]] = None,
                 definition_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 workspace_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a DestinationMilvus resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['DestinationMilvusConfigurationArgs']] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
               configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
               model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
               Advanced configuration Processing, embedding and advanced configuration are provided by this base class, while the
               indexing configuration is provided by the destination connector in the sub class.
    ...
    def __init__(__self__,
        ...
        Create a DestinationMilvus resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DestinationMilvusArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DestinationMilvusArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DestinationMilvusArgs.__new__(DestinationMilvusArgs)
        ...
        super(DestinationMilvus, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            destination_type: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            workspace_id: Optional[pulumi.Input[str]] = None) -> 'DestinationMilvus':
        """
        ...
        __props__ = _DestinationMilvusState.__new__(_DestinationMilvusState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["workspace_id"] = workspace_id
        return DestinationMilvus(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.DestinationMilvusConfiguration']:
        """
        The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination
        configuration, as well as to provide type safety for the configuration passed to the destination. The configuration
        model is composed of four parts: * Processing configuration * Embedding configuration * Indexing configuration *
