...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourcePolygonStockApiOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourcePolygonStockApi) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
