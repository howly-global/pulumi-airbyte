...
func (o LookupDestinationPostgresResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationPostgresResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationPostgresResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationPostgresResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
