...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourceClockifyOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceClockify) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
