...
func (o LookupSourceGithubResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceGithubResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceGithubResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceGithubResult) string { return v.SourceType }).(pulumi.StringOutput)
}
