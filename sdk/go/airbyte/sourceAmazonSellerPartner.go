...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourceAmazonSellerPartnerOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceAmazonSellerPartner) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
