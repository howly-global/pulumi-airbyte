...
func (o LookupSourcePaystackResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePaystackResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourcePaystackResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePaystackResult) string { return v.SourceType }).(pulumi.StringOutput)
}
