...
// ID of organization to add workspace to. Requires replacement if changed.
func (o WorkspaceOutput) OrganizationId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Workspace) pulumi.StringPtrOutput { return v.OrganizationId }).(pulumi.StringPtrOutput)
}
