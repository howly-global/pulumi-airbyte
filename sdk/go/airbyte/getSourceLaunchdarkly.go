...
func (o LookupSourceLaunchdarklyResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceLaunchdarklyResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceLaunchdarklyResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceLaunchdarklyResult) string { return v.SourceType }).(pulumi.StringOutput)
}
