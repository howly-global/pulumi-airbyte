...
func (o LookupSourceAmazonSqsResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceAmazonSqsResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceAmazonSqsResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceAmazonSqsResult) string { return v.SourceType }).(pulumi.StringOutput)
}
