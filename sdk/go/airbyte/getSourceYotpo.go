...
func (o LookupSourceYotpoResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceYotpoResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceYotpoResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceYotpoResult) string { return v.SourceType }).(pulumi.StringOutput)
}
