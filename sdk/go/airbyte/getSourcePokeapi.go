...
func (o LookupSourcePokeapiResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePokeapiResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourcePokeapiResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePokeapiResult) string { return v.SourceType }).(pulumi.StringOutput)
}
