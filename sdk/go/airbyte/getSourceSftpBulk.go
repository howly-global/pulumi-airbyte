...
func (o LookupSourceSftpBulkResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceSftpBulkResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceSftpBulkResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceSftpBulkResult) string { return v.SourceType }).(pulumi.StringOutput)
}
