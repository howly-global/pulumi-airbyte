...
func (o LookupSourcePypiResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePypiResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourcePypiResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePypiResult) string { return v.SourceType }).(pulumi.StringOutput)
}
