...
func (o LookupSourcePolygonStockApiResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePolygonStockApiResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourcePolygonStockApiResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourcePolygonStockApiResult) string { return v.SourceType }).(pulumi.StringOutput)
}
