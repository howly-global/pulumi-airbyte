...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationPostgresOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationPostgres) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
