...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationS3Output) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationS3) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
