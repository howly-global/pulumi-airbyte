...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourceAuth0Output) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceAuth0) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
