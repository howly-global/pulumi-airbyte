...
func (o LookupSourceFacebookMarketingResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceFacebookMarketingResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceFacebookMarketingResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceFacebookMarketingResult) string { return v.SourceType }).(pulumi.StringOutput)
}
