...
func (o LookupSourceDockerhubResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceDockerhubResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceDockerhubResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceDockerhubResult) string { return v.SourceType }).(pulumi.StringOutput)
}
