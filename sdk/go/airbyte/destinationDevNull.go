...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationDevNullOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationDevNull) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
