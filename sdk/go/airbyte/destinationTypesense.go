...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationTypesenseOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationTypesense) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
