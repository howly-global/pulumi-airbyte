...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationFirestoreOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationFirestore) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
