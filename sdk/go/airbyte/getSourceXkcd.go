...
func (o LookupSourceXkcdResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceXkcdResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceXkcdResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceXkcdResult) string { return v.SourceType }).(pulumi.StringOutput)
}
