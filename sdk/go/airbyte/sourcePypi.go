...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourcePypiOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourcePypi) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
