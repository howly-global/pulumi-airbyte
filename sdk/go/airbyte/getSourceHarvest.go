...
func (o LookupSourceHarvestResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceHarvestResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceHarvestResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceHarvestResult) string { return v.SourceType }).(pulumi.StringOutput)
}
