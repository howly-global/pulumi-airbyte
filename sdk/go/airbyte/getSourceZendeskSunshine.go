...
func (o LookupSourceZendeskSunshineResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceZendeskSunshineResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceZendeskSunshineResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceZendeskSunshineResult) string { return v.SourceType }).(pulumi.StringOutput)
}
