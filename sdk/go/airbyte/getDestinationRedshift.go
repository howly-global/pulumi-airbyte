...
func (o LookupDestinationRedshiftResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationRedshiftResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationRedshiftResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationRedshiftResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
