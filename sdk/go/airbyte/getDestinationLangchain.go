...
func (o LookupDestinationLangchainResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationLangchainResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationLangchainResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationLangchainResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
