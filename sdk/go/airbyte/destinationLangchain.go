...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationLangchainOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationLangchain) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
