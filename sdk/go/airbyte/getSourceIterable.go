...
func (o LookupSourceIterableResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceIterableResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceIterableResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceIterableResult) string { return v.SourceType }).(pulumi.StringOutput)
}
