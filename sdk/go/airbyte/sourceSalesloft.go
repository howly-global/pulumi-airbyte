...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourceSalesloftOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceSalesloft) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
