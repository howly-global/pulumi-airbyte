...
func (o LookupSourceExchangeRatesResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceExchangeRatesResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceExchangeRatesResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceExchangeRatesResult) string { return v.SourceType }).(pulumi.StringOutput)
}
