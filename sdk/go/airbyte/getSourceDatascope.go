...
func (o LookupSourceDatascopeResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceDatascopeResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceDatascopeResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceDatascopeResult) string { return v.SourceType }).(pulumi.StringOutput)
}
