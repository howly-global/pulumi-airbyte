...
func (o LookupSourceStravaResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceStravaResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceStravaResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceStravaResult) string { return v.SourceType }).(pulumi.StringOutput)
}
