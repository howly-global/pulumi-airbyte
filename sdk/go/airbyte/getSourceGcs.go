...
func (o LookupSourceGcsResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceGcsResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceGcsResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceGcsResult) string { return v.SourceType }).(pulumi.StringOutput)
}
