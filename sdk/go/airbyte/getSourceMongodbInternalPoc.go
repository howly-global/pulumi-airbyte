...
func (o LookupSourceMongodbInternalPocResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceMongodbInternalPocResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceMongodbInternalPocResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceMongodbInternalPocResult) string { return v.SourceType }).(pulumi.StringOutput)
}
