...
func (o LookupDestinationDynamodbResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationDynamodbResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationDynamodbResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationDynamodbResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
