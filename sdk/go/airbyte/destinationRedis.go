...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationRedisOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationRedis) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
