...
func (o LookupSourceOktaResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceOktaResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceOktaResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceOktaResult) string { return v.SourceType }).(pulumi.StringOutput)
}
