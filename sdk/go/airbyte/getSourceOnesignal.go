...
func (o LookupSourceOnesignalResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceOnesignalResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceOnesignalResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceOnesignalResult) string { return v.SourceType }).(pulumi.StringOutput)
}
