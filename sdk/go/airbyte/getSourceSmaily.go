...
func (o LookupSourceSmailyResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceSmailyResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceSmailyResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceSmailyResult) string { return v.SourceType }).(pulumi.StringOutput)
}
