...
func (o LookupSourceFreshcallerResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceFreshcallerResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupSourceFreshcallerResultOutput) SourceType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupSourceFreshcallerResult) string { return v.SourceType }).(pulumi.StringOutput)
}
