...
func (o LookupDestinationConvexResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationConvexResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationConvexResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationConvexResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
