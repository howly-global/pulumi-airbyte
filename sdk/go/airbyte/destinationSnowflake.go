...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
// replacement if changed.
func (o DestinationSnowflakeOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationSnowflake) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
