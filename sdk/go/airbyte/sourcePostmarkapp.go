...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires
// replacement if changed.
func (o SourcePostmarkappOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourcePostmarkapp) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
