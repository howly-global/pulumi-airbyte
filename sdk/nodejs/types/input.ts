...
export interface ConnectionConfigurationsStream {
    /**
     * Path to the field that will be used to determine if a record is new or modified since the last sync. This field is REQUIRED if `syncMode` is `incremental` unless there is a default.
     */
    ...
    /**
     * Paths to the fields that will be used as primary key. This field is REQUIRED if `destinationSyncMode` is `*_dedup` unless it is already supplied by the source schema.
     */
    primaryKeys?: pulumi.Input<pulumi.Input<pulumi.Input<string>[]>[]>;
    /**
     * must be one of ["fullRefreshOverwrite", "fullRefreshAppend", "incrementalAppend", "incrementalDedupedHistory"]
     */
...
export interface DestinationAstraConfigurationIndexing {
    ...
    /**
     * Keyspaces (or Namespaces) serve as containers for organizing data within a database. You can create a new keyspace uisng the Data Explorer tab in the Astra UI. The keyspace defaultKeyspace is created for you when you create a Vector Database in Astra DB.
     */
...
export interface DestinationClickhouseConfigurationTunnelMethodSshKeyAuthentication {
    /**
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuserRsa )
     */
...
export interface DestinationRedshiftConfigurationUploadingMethod {
     ...
     */
    standard?: pulumi.Input<inputs.DestinationRedshiftConfigurationUploadingMethodStandard>;
}
...
export interface DestinationRedshiftConfigurationUploadingMethodStandard {
}
...
export interface DestinationTeradataConfiguration {
    ...
    password?: pulumi.Input<string>;
    /**
     * The default schema tables are written to if the source does not specify a namespace. The usual value for this field is "public". Default: "airbyteTd"
     */
    schema?: pulumi.Input<string>;
    /**
...
export interface SourceAzureBlobStorageConfigurationStreamFormatDocumentFileTypeFormatExperimental {
    ...
    /**
     * The strategy used to parse documents. `fast` extracts text directly from the document which doesn't work for all files. `ocrOnly` is more reliable, but slower. `hiRes` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode. See the unstructured.io documentation for more details: https://unstructured-io.github.io/unstructured/core/partition.html#partition-pdf. must be one of ["auto", "fast", "ocrOnly", "hiRes"]; Default: "auto"
     */
...
export interface SourceClockifyConfiguration {
    /**
     * You can get your api accessKey <a href="https://app.clockify.me/user/settings">here</a> This API is Case Sensitive.
     */
    apiKey: pulumi.Input<string>;
    /**
...
export interface SourceFacebookMarketingConfiguration {
    ...
    /**
     * Allows actionBreakdowns to be an empty list. Default: true
     */
    ...
    endDate?: pulumi.Input<string>;
    /**
     * Set to active if you want to fetch the thumbnailUrl and store the result in thumbnailDataUrl for each Ad Creative. Default: false
     */
...
export interface SourceFacebookMarketingConfigurationCustomInsight {
    /**
     * A list of chosen actionBreakdowns for action_breakdowns
     */
...
export interface SourceFakerConfiguration {
    /**
     * Should the updatedAt values for every record be new each sync?  Setting this to false will case the source to stop emitting records after COUNT records have been emitted. Default: true
     */
...
export interface SourceFaunaConfigurationCollectionDeletionsEnabled {
    /**
     * Name of the "deleted at" column. Default: "deletedAt"
     */
...
export interface SourceFileConfiguration {
    ...
    /**
     * The Format of the file which should be replicated (Warning: some formats may be experimental, please refer to the docs). must be one of ["csv", "json", "jsonl", "excel", "excelBinary", "fwf", "feather", "parquet", "yaml"]; Default: "csv"
     */
...
export interface SourceGoogleSearchConsoleConfigurationCustomReportsArray {
    /**
     * A list of available dimensions. Please note, that for technical reasons `date` is the default dimension which will be included in your query whether you specify it or not. Primary key will consist of your custom dimensions and the default dimension along with `siteUrl` and `searchType`.
     */
    dimensions: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * The name of the custom report, this name would be used as stream name
...
export interface SourceOrbConfiguration {
    ...
    apiKey: pulumi.Input<string>;
    /**
     * UTC date and time in the format 2022-03-01T00:00:00Z. Any data with createdAt after this data will not be synced. For Subscription Usage, this becomes the `timeframeStart` API parameter.
     */
    endDate?: pulumi.Input<string>;
    /**
...
export interface SourceS3Configuration {
    ...
    /**
     * Deprecated and will be removed soon. Please do not use this field anymore and use bucket, aws_access_key_id, awsSecretAccessKey and endpoint instead. Use this to load files from S3 or S3-compatible services
     */
...
export interface SourceS3ConfigurationFormatJsonl {
    ...
    newlinesInValues?: pulumi.Input<boolean>;
    /**
     * How JSON fields outside of explicitSchema (if given) are treated. Check <a href="https://arrow.apache.org/docs/python/generated/pyarrow.json.ParseOptions.html" target="_blank">PyArrow documentation</a> for details. must be one of ["ignore", "infer", "error"]; Default: "infer"
     */
...
export interface SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
    ...
    /**
     * Process files via an API, using the `hiRes` mode. This option is useful for increased performance and accuracy, but requires an API key and a hosted instance of unstructured.
     */
...
export interface SourceTrustpilotConfiguration {
    /**
     * The names of business units which shall be synchronized. Some streams e.g. configuredBusinessUnits or privateReviews use this configuration.
     */
