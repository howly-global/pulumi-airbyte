...
namespace Pulumi.Airbyte.Outputs
{
    ...
    [OutputType]
    public sealed class DestinationTeradataConfigurationSslModeVerifyFull
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DestinationTeradataConfigurationSslModeVerifyFull(string sslCaCertificate)
        {
