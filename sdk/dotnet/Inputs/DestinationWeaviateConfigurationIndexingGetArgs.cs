...
namespace Pulumi.Airbyte.Inputs
{
    ...
    public sealed class DestinationWeaviateConfigurationIndexingGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("additionalHeaders")]
        private InputList<Inputs.DestinationWeaviateConfigurationIndexingAdditionalHeaderGetArgs>? _additionalHeaders;

        /// <summary>
        /// Additional HTTP headers to send with every request.
        /// </summary>
        public InputList<Inputs.DestinationWeaviateConfigurationIndexingAdditionalHeaderGetArgs> AdditionalHeaders
        {
            get => _additionalHeaders ?? (_additionalHeaders = new InputList<Inputs.DestinationWeaviateConfigurationIndexingAdditionalHeaderGetArgs>());
        ...
        public Input<Inputs.DestinationWeaviateConfigurationIndexingAuthGetArgs> Auth { get; set; } = null!;
        ...
        public DestinationWeaviateConfigurationIndexingGetArgs()
        {
        }
        public static new DestinationWeaviateConfigurationIndexingGetArgs Empty => new DestinationWeaviateConfigurationIndexingGetArgs();
    }
}
