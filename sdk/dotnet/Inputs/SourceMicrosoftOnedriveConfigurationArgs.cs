...
namespace Pulumi.Airbyte.Inputs
{
    ...
    public sealed class SourceMicrosoftOnedriveConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Credentials for connecting to the One Drive API
        /// </summary>
        [Input("credentials", required: true)]
        public Input<Inputs.SourceMicrosoftOnedriveConfigurationCredentialsArgs> Credentials { get; set; } = null!;
        ...
        private InputList<Inputs.SourceMicrosoftOnedriveConfigurationStreamArgs>? _streams;

        /// <summary>
        /// Each instance of this configuration defines a &lt;a href="https://docs.airbyte.com/cloud/core-concepts#stream"&gt;stream&lt;/a&gt;. Use this to define which files belong in the stream, their format, and how they should be parsed and validated. When sending data to warehouse destination such as Snowflake or BigQuery, each stream is a separate table.
        /// </summary>
        public InputList<Inputs.SourceMicrosoftOnedriveConfigurationStreamArgs> Streams
        {
            get => _streams ?? (_streams = new InputList<Inputs.SourceMicrosoftOnedriveConfigurationStreamArgs>());
            set => _streams = value;
        }

        public SourceMicrosoftOnedriveConfigurationArgs()
        {
        }
        public static new SourceMicrosoftOnedriveConfigurationArgs Empty => new SourceMicrosoftOnedriveConfigurationArgs();
    }
}
