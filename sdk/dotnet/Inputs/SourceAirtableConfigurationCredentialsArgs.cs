...
namespace Pulumi.Airbyte.Inputs
{
    ...
    {
        [Input("oAuth20")]
        public Input<Inputs.SourceAirtableConfigurationCredentialsOAuth20Args>? OAuth20 { get; set; }

        [Input("personalAccessToken")]
        public Input<Inputs.SourceAirtableConfigurationCredentialsPersonalAccessTokenArgs>? PersonalAccessToken { get; set; }
