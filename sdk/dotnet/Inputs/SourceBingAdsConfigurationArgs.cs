...
namespace Pulumi.Airbyte.Inputs
{
    ...
    {
        [Input("accountNames")]
        private InputList<Inputs.SourceBingAdsConfigurationAccountNameArgs>? _accountNames;

        /// <summary>
        /// Predicates that will be used to sync data by specific accounts.
        /// </summary>
        public InputList<Inputs.SourceBingAdsConfigurationAccountNameArgs> AccountNames
        {
            get => _accountNames ?? (_accountNames = new InputList<Inputs.SourceBingAdsConfigurationAccountNameArgs>());
        ...
        [Input("customReports")]
        private InputList<Inputs.SourceBingAdsConfigurationCustomReportArgs>? _customReports;

        /// <summary>
        /// You can add your Custom Bing Ads report by creating one.
        /// </summary>
        public InputList<Inputs.SourceBingAdsConfigurationCustomReportArgs> CustomReports
        {
            get => _customReports ?? (_customReports = new InputList<Inputs.SourceBingAdsConfigurationCustomReportArgs>());
