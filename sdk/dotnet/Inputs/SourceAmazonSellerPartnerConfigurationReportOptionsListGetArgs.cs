...
namespace Pulumi.Airbyte.Inputs
{
    ...
    public sealed class SourceAmazonSellerPartnerConfigurationReportOptionsListGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("optionsLists", required: true)]
        private InputList<Inputs.SourceAmazonSellerPartnerConfigurationReportOptionsListOptionsListGetArgs>? _optionsLists;

        /// <summary>
        /// List of options
        /// </summary>
        public InputList<Inputs.SourceAmazonSellerPartnerConfigurationReportOptionsListOptionsListGetArgs> OptionsLists
        {
            get => _optionsLists ?? (_optionsLists = new InputList<Inputs.SourceAmazonSellerPartnerConfigurationReportOptionsListOptionsListGetArgs>());
        ...
        public SourceAmazonSellerPartnerConfigurationReportOptionsListGetArgs()
        {
        }
        public static new SourceAmazonSellerPartnerConfigurationReportOptionsListGetArgs Empty => new SourceAmazonSellerPartnerConfigurationReportOptionsListGetArgs();
    }
}
