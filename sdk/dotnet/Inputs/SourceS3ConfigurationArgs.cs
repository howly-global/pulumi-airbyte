...
namespace Pulumi.Airbyte.Inputs
{
    ...
    public sealed class SourceS3ConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("provider")]
        public Input<Inputs.SourceS3ConfigurationProviderArgs>? Provider { get; set; }
        ...
        private InputList<Inputs.SourceS3ConfigurationStreamArgs>? _streams;

        /// <summary>
        /// Each instance of this configuration defines a &lt;a href="https://docs.airbyte.com/cloud/core-concepts#stream"&gt;stream&lt;/a&gt;. Use this to define which files belong in the stream, their format, and how they should be parsed and validated. When sending data to warehouse destination such as Snowflake or BigQuery, each stream is a separate table.
        /// </summary>
        public InputList<Inputs.SourceS3ConfigurationStreamArgs> Streams
        {
            get => _streams ?? (_streams = new InputList<Inputs.SourceS3ConfigurationStreamArgs>());
            set => _streams = value;
        }
